...
export const DEFAULT_OPTIONS: ResolvedOptions = {
  ...
  rack: { unitHeight: 0.445, width: 5.6, depth: 4.0, postSize: 0.16, showSidePanels: true, showRearPanel: true, showNameplate: true, nameplateScale: 1.0, nameplateYOffset: 0.2, nameplateOpacity: 1.0 },
